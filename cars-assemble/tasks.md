...
Implement a function that takes in the number of cars produced per hour and the success rate and calculates the number of successful cars made per hour. The success rate is given as a percentage, from <code>0</code> to <code>100</code>.


Note: the return value should be a <code>float64</code>.
...
Note: the return value should be an <code>int</code>.
...
Implement the function <code>CalculateCost</code> that calculates the cost of producing a number of cars, regardless of whether they are successful:
